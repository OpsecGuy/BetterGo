    ...
    def menu(self):
        ...
        with dpg.window(label='Menu', user_data='menu', tag='#menu', width=600, height=600, no_close=True, no_move=True):
            with dpg.collapsing_header(label="Aimbot"):
                ...
                dpg.add_slider_float(label='RCS Strength', default_value=0.0, min_value=0.0, max_value=2.0, width=215, user_data='rcs_strength', tag='rcs_strength')
                dpg.add_slider_int(label='Shot After x Bullets', default_value=0, min_value=0, max_value=30, width=215, user_data='rcs_get_bullets', tag='rcs_get_bullets')
                dpg.add_separator()
                ...
                dpg.add_combo(label='Key', items=tuple(h.gui_keys_list.keys()), default_value='MOUSE 5', width=215, user_data='triggerbot_key', tag='triggerbot_key')
                dpg.add_slider_float(label='TriggerBot Delay', default_value=0.025, min_value=0.01, max_value=0.1, width=215, user_data='triggerbot_delay', tag='triggerbot_delay')
                dpg.add_combo(label='Key', items=tuple(h.gui_keys_list.keys()), default_value='MOUSE 4', width=215, user_data='autopistol_key', tag='autopistol_key')
            ...
            with dpg.collapsing_header(label='Misc'):
                ...
                dpg.add_slider_float(label='No Flash Strength', default_value=255.0, min_value=0.0, max_value=255.0, width=215, user_data='noflash_strength', tag='noflash_strength')
                dpg.add_checkbox(label='Night Mode', user_data='nightmode_checkbox', tag='nightmode_checkbox')
                dpg.add_slider_float(label='Night Mode Strength', default_value=0.3, min_value=0.01, max_value=3.0, width=215, user_data='nightmode_strength', tag='nightmode_strength')
                dpg.add_checkbox(label='Fake Lag', user_data='fakelag_checkbox', tag='fakelag_checkbox')
                dpg.add_slider_float(label='Fake Lag Strength', default_value=0.001, min_value=0.001, max_value=0.016, width=215, user_data='fakelag_strength', tag='fakelag_strength')
                dpg.add_slider_int(label='FOV', default_value=90, min_value=60, max_value=160, width=215, user_data='fov', tag='fov')
                dpg.add_combo(label='Sky', items=list(h.sky_list), default_value='', width=215, user_data='sky_name', tag='sky_name')

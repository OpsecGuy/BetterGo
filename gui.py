...
class GUI():
    ...
    def menu(self):
        ...
        with dpg.window(tag='w_main'):
            with dpg.collapsing_header(label="Aimbot", tag='aimbot_header'):
                ...
                dpg.add_slider_float(label='Aimbot Smooth', default_value=3.0, min_value=1.0, max_value=30.0, width=215, tag='s_aimbot_smooth')
    ...
    def override(self):
        ...
        dpg.set_value('c_aimbot_bone', Config.read('aimbot','bone'))
